...
// Este es el script de los lasers
// Es de un asset, no le cambiamos nada
// Se encarga de las texturas

// Este script está puesto en cada laser que se instancia y se destruye (Está en el prefab "Laser Beam 1")
